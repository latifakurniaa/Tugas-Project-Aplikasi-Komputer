...
\end{eulerprompt}
\begin{eulercomment}
Fungsi geometri meliputi fungsi untuk membuuat garis dan lingkaran.
...
Jawab :\\
Ditentukan ketiga titik singgung lingkaran dalam dengan sisi-sisi
segitiga ABC.
\end{eulercomment}
\begin{eulerprompt}
>setPlotRange(-4.5,1.5,-1.5,4.5);
>A=[-3,2]; plotPoint(A,"A");
>B=[-1,0]; plotPoint(B,"B");
>C=[1,4]; plotPoint(C,"C");
\end{eulerprompt}
\begin{eulercomment}
Digambarkan segitiga dengan titik-titik sudut ketiga titik singgung
tersebut. 
\end{eulercomment}
\begin{eulerprompt}
>plotSegment(A,B,"c")
...
Dihitung luas segitiga tersebut.
\end{eulercomment}
\begin{eulerprompt}
>areaTriangle(A,B,C)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Ditunjukkan bahwa garis bagi sudut yang ke tiga juga melalui titik
pusat lingkaran dalam. Juga jari-jari lingkaran dalam.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Dihitung luas lingkaran luar dan luas lingkaran dalam segitiga ABC.
\end{eulercomment}
\begin{eulerprompt}
...
File geometry.e menyediakan fungsi yang sama(dan lebih banyak lagi) di
...
\end{eulerprompt}
\begin{eulercomment}
Fungsi garis dan lingkaran berfungsi sama seperti fungsi Euler, namum
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-011-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-017-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-033.png}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Tentu saja, setiap segitiga siku-siku adalah kasus yang baik.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry-037.png}
\begin{eulercomment}
Dalam kasus yang umum juga berhasil.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Sekarang kita cari himpunan semua titik di mana b+c=d untuk suatu
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry-041-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-049-large.png}
\begin{eulercomment}
...
\begin{eulercomment}
Euler line adalah garis yang ditentukan dari sembarang segitiga yang
...
orthocenter, circumcenter, centroid, Exeter point dan center lingkaran
sembilan titik segitiga.

Untuk demonstrasinya, kita menghitung dan memplot Euler line dalam
sebuah segitiga.
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-060-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Plot lingkaran dan pusatnya. Cu dan U bersifat simbolik. Kita
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-073.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-075.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-080-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-083-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-084.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-092-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-100-large.png}
\eulerimg{0}{images/EMT4Geometry-101-large.png}
\begin{eulercomment}
Pertama, mari kita hitung sudut tradisional. Fungsi menghitung sudut
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-108-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-117-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-125-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-127.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry-129-large.png}
\eulerimg{1}{images/EMT4Geometry-130-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-132.png}
\begin{eulercomment}
...
\begin{eulercomment}
dan grafiknya cukup sederhana untuk: bagian atas kerucut:
\end{eulercomment}
\begin{eulerprompt}
...
A), maka sudut minimum dicapai pada banyak titik tersebut (katakanlah
AB+AC).
...
\begin{eulercomment}
Dari gambar diatas jarak titik pusat ke titik-titik sudut segi-5
tersebut merupakan jari-jari lingkaran luar segi-5.
\end{eulercomment}
\begin{eulercomment}
2. Gambarlah suatu parabola yang melalui 3 titik yang diketahui.
\end{eulercomment}
...
>c=circleThrough(A,B,C); 
>R=getCircleRadius(c); O=getCircleCenter(c);
>plotPoint(O,"O");
>l=angleBisector(A,B,C);
...
singgung lingkaran yang sama lingkaran dalam segiempat.\\
...
\end{eulerudf}
\begin{eulerprompt}
>fcontour("d2",xmin=-2,xmax=2,ymin=-2,ymax=1,hue=1):
\end{eulerprompt}
\begin{eulerudf}
