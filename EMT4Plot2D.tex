...
\begin{eulernotebook}
\begin{eulercomment}
Nama  : Latifa Kurnia Zahra Tunisa\\
NIM   : 22305144040\\
Kelas : Matemtika B\\
\begin{eulercomment}
...
apakah layarnya berbentuk persegi atau tidak. Dan ada koordinat plot
...
>window(0,0,1024,1024); // untuk menggunakan seluruh jendela
>setplot(0,1,0,1); // untuk mengatur koordinat plot
>hold on; // untuk memulai mode timpa
>n=100; X=random(n,2); Y=random(n,2);  // untuk mendapatkan poin acak
>colors=rgb(random(n),random(n),random(n)); // untuk mendapatkan warna acak
>loop 1 to n; color(colors[#]); plot(X[#],Y[#]); end; // untuk menggambarkan plot
>hold off; // untuk mengakhiri mode timpa
>insimg; // untuk memasukkan ke buku catatan
\end{eulerprompt}
...
Ingat bahwa jendela ini tidak memberikan ruang untuk label sumbu di
luar jendela plot. Kita harus menambahkan beberapa margin untuk ini
sesuai kebutuhan. Ingat bahwa kita menyimpan dan memulihkan jendela
penuh, dan menahan plot saat ini sementara kita memplot inset.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("x^3-x");
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
Di Maxima dimungkinkan untuk membuat plot menggunakan Gnuplot atau
...
Berikut ini contoh paling dasar, yang menggunakan rentang default dan
menetapkan rentang y yang tepat agar sesuai dengan plot fungsinya.
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-010.png}
\begin{eulercomment}
...
(lihat dibawah untuk perintah figure()). Gaya grid=0 tidak disertakan.
Ini tidak menunjukkan grid dan bingkai.
\end{eulercomment}
\begin{eulerprompt}
>figure(3,3); ...
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-011.png}
\begin{eulercomment}
...
\begin{eulercomment}
Gambar yag dihasilkan dengan memasukkan plot ke dalam jendela teks
...
\begin{eulercomment}
Paramater square=true (atau \textgreater{}square) memilih rentang y- secara
otomatis sehingga hasilnya adalah jendela plot persegi. Perhatikan
bahwa secara default, Euler menggunakan spasi persegi di dalam jendela
plot.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("x^3-x",>square):
...
- ekspresi atau eksspresi simbolik di x\\
...
- style (gaya) ="...". Pilih dari "-", "--", "-.", ".", ".-.", "-.-".\\
- color (warna) : Lihat di bawah untuk warna.\\
- thickness (ketebalan) : Defaultnya adalah 1.

Warna dapat dipilih sebagai salah satu warna default atau sebagai
warna RGB.

- 0..15: indeks warna default.\\
- color constants (konstanta warna) : white (putih), black (hitam),
red (merah), green (hijau), blue(biru), cyan (hijau tosca), olive
(hijau zaitun), lightgray (abu-abu muda), gray (abu-abu), darkgray
(abu-abu tua), orange, lightgreen (hijau muda), turquoise (pirus),
lightblue (biru muda), lightorange (orange muda), yellow (kuning)\\
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-037.png}
\begin{eulercomment}
Tapi Anda dapat menggunakan warna apapun.
\end{eulercomment}
\begin{eulerprompt}
>columnsplot(ones(1,16),grid=0,color=rgb(0,0,linspace(0,1,15))):
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-038.png}
\eulerheading{Menggambar Beberapa Kurva pada bidang koordinat yang sama}
\begin{eulercomment}
Plot lebih dari satu fungsi (multiple functions) ke dalam satu jendela
dapat dilakukan dengan berbagai cara. Salah satu metodenya adalah
menggunakan \textgreater{}add untuk beberapa panggilan plot2d secara keseluruhan,
kecuali panggilan pertama. Kami telah menggunakan fitur ini pada
contoh di atas.
\end{eulercomment}
\begin{eulerprompt}
>aspect(); plot2d("cos(x)",r=2,grid=6); plot2d("x",style=".",>add):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-039.png}
\begin{eulerprompt}
...
panggilan ke plot2d(). Yang kedua dan yang ketiga memiliki tanda \textgreater{}add,
...
\begin{eulercomment}
Dalam contoh berikut, kami menghasilkan Bernstein-Polynomials.
...
Kami menghasilkan matriks nilai dengan satu Bernstein-Polynomial idi
...
\begin{eulercomment}
Ingat bahwa parameter warna dapat berupa vektor. Kemudian setiap
wwarna digunakan untuk setiap baris matriks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-051.png}
\begin{eulercomment}
...
\begin{eulercomment}
Kotak ini berlabuh di kanan atas secara default, tetapi \textgreater{}left berlabuh
...
merupakan pecahan dari ukuran jendela grafik. Lebarnya otomatis.

Untuk plot titik, kotak label juga berfungsi. Tambahkan parameter
\textgreater{}points, atau tanda vektor, satu untuk setiap label.
...
Catatan, penguraian LaTeX lambat. Jika Anda ingin menggunakan LaTeX
...
konformal pada sumbu x. Kita bisa gunakan xaxis() dan yaxis() aseperti
...
itu tidak perlu. Tapi untuk menunjukkan vektorisasi itu berguna, kita
menambahkan beberapa poin penting ke plot di x=-1, x=0 and x=1.

Pada plot berikut, kamu juga memasukkan beberapa kode LaTeX. Kami
menggunakannya untuk dua label dan kotak teks. Tentu saja, Anda hanya
bisa menggunakan LaTeX jika Anda telah menginstal LaTeX dengan benar.
\end{eulercomment}
\begin{eulerprompt}
...
> figure(3); plot2d("x^3-x",grid=2); ... // tick default
> figure(4); plot2d("x^3-x",grid=3); ... // sumbu x-y- dengan label di dalamnya
> figure(5); plot2d("x^3-x",grid=4); ... // tidak ada tick, hanya label
> figure(6); plot2d("x^3-x",grid=5); ... // default, tetapi tidak ada margin
> figure(7); plot2d("x^3-x",grid=6); ... // kurva saja
> figure(8); plot2d("x^3-x",grid=7); ... // kurva saja, ticks pada sumbunya
> figure(9); plot2d("x^3-x",grid=8); ... // kurva saja, tick yang lebih halus pada sumbunya
> figure(10); plot2d("x^3-x",grid=9); ... // default, tick kecil didalamnya
> figure(11); plot2d("x^3-x",grid=10); ...// tidak ada tick, kurva saja
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-072.png}
\begin{eulercomment}
...
>plot2d(xdata,ydata,a=0.5,b=4.5,c=2.5,d=3.5,style="."); // baris
...
- filled (terisi)=true mengisi plot.\\
- style (gaya)="...": Pilih dari "#", "/", "\textbackslash{}", "\textbackslash{}/".\\
...
>figure(2); plot2d(x,y,r=10,>filled,style="/",fillcolor=red); // kurva terisi
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-091.png}
\begin{eulercomment}
...
bisa\\
uga dapat digunakan untuk memplot kesalahan statistik.
\end{eulercomment}
\begin{eulerprompt}
>t=0:0.1:1; ...
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-093.png}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // menentukan ekspresi f(x,y)
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-096.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-097.png}
...
\end{eulerformula}
\begin{eulercomment}
Kita juga perlu menggunakan banyak titik untuk tampilan yang halus
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-100.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-104.png}
...
vektor garis kisi 1x2) dalam argumen cgrid, hanya garis grid tersebut
yang terlihat.
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-105.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-106.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-109.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-111.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-112.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-113.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-114.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-115.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-116.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-117.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-118.png}
\begin{eulercomment}
...
>plot2d(w,>distribution): // atau distribution=n dengan n interval
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-119.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-121.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-125.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-126.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-129.png}
\begin{eulercomment}
Ingat bahwa ada banyak plot statistik yang mungkin berguna. Silahkan
lihat tutorial tentang statistik.
\end{eulercomment}
\begin{eulerprompt}
>columnsplot(getmultiplicities(1:6,intrandom(1,6000,6))):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-130.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-132.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-134.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // menentukan ekspresi f(x,y)
>plot2d(expr,level=0): // solusi f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-135.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // bagus
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-136.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // lebih bagus
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-138.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-139.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-140.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-141.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-142.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-143.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-144.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-147.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-148.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-149.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-150.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-155.png}
\begin{eulercomment}
...
>plot2d(["sin(2x)","cos(x)^2"],0,2pi):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-165.png}
\begin{eulercomment}
2. Tentukan asimtot dari fungsi rasional berikut\\
\end{eulercomment}
\begin{eulerformula}
\[
\frac{2x-4}{x^2-4}
...
\begin{eulerprompt}
>reset();
>plot2d("(2*x-4)/(x^2-4)",-2,2); insimg(20)
\end{eulerprompt}
\eulerimg{19}{images/EMT4Plot2D-167.png}
\begin{eulercomment}
3. Tentukan plot dari fungsi\\
\end{eulercomment}
\begin{eulerformula}
\[
2x^2+x+2
...
\end{eulercomment}
\begin{eulerprompt}
>plot2d("2*x^2+x+2",grid=4):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-169.png}
\begin{eulercomment}
4. Buatlah grafik fungsi f(x) dibawah beserta turunannya dalam satu
plot.\\
\end{eulercomment}
\begin{eulerformula}
\[
...
\end{euleroutput}
\begin{eulerprompt}
>plot2d(&f(x), color=red,thickness=3); // grafik fungsi f(x)
>plot2d(&diff(f(x),x),>add,color=green,style="--",thickness=3): // turunan f(x)
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-171.png}
