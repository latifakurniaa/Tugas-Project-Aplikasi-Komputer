...
uler menggambar fungsi tersebut menggunakan algoritma pengurutan untuk
menyembunyikan bagian di latar belakang. Secara umum Euler menggunakan
proyeksi sentral. Standarnya adalah dari kuadran xy positif menuju
titik asal x=y=z=0, tetapi sudut=0° dilihat dari arah sumbu y. Sudut
...
memplot ekspresi dalam x dan y. Parameter r mengatur\\
rentang plot sekitar (0,0).
\end{eulercomment}
\begin{eulerprompt}
...
sisi. Perhatikan bahwa jumlah interval kisi default adalah\\
10, tetapi plot menggunakan jumlah default persegi panjang 40x40 untuk
membuat permukaannya. Ini bisa diubah.
...
spektral. Euler dapat ketinggian fungsi pada plot dengan arsiran. Di
semua plot 3D, Euler dapat\\
menghasilkan anaglyph merah/cyan. 
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-019.png}
\begin{eulercomment}
...
- white: untuk rentang yang lebih\\
...
- implicit=1: potong sejajar bidang yz\\
- implicit=2: potong sejajar bidang xz \\
- implicit=4: potong sejajar bidang xy
...
fx(x,y), fy(x,y), fz(x,y). ÿ(t, s) = (x(t, s), 
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-046.png}
\begin{eulercomment}
EMT juga dapat membuat plot dalam mode anaglyph. Untuk melihat plot
seperti itu, Anda memerlukan kacamata berwarna red/cyan.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-050.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot3D-060.png}
\begin{eulercomment}
...
objek.\\
t jantung yang diputar sebagai permukaan parametrik.
\end{eulercomment}
\begin{eulerprompt}
>function f(x,y,z) ...
\end{eulerprompt}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D-063.png}
...
\end{euleroutput}
\eulerimg{27}{images/EMT4Plot3D-064.png}
\eulerheading{Menggambar Povray}
\begin{eulercomment}
Dengan bantuan file Euler povray.e, Euler dapat menghasilkan file
Povray. Hasilnya sangat bagus untuk dilihat. Anda perlu menginstal
Povray (32bit atau 64bit) dari http://www.povray.org/, dan meletakkan
sub-direktori "bin" Povray ke jalur lingkungan, atau mengatur variabel
"defaultpovray" dengan jalur lengkap yang mengarah ke "pvengine.exe".
...
povstart(). Kemudian gunakan\\
writeln(...) untuk menulis objek ke file adegan. Terakhir, akhiri file
dengan povend(). Secara default, raytracer akan dimulai, dan PNG akan
...
Ini memiliki parameter untuk warna,\\
transparansi, Phong Shading dll.

Perhatikan bahwa alam semesta Povray memiliki sistem koordinat lain.
Antarmuka ini menerjemahkan semua koordinat ke sistem Povray. Jadi
Anda dapat terus berpikir dalam sistem koordinat Euler dengan z
menunjuk vertikal ke atas, dan\\
sumbu x,y,z di tangan kanan.\\
Anda perlu membuat file povray.
\end{eulercomment}
\begin{eulerprompt}
>load povray;
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D-065.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D-067.png}
\begin{eulercomment}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-068.png}
...
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-069.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/EMT4Plot3D-070.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot3D-072.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-073.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-074.png}
...
>povend;
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-075.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-076.png}
\begin{eulercomment}
Perbedaan memungkinkan pemisahan satu objek dari objek lainnya. Seperi
persimpangan ada bagian dari objek CSG di Povray.
\end{eulercomment}
\begin{eulerprompt}
>povstart(light=[5,-5,5],fade=10);
\end{eulerprompt}
\begin{eulercomment}
Untuk demonstrasi ini, kami mendifinisikan objek di Povray, alih-alih
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-077.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-079.png}
\begin{eulerprompt}
>povstart(angle=25°,height=10°); 
>writeln(povsurface("pow(x,2)+pow(y,2)*pow(z,2)-1",povlook(blue),povbox(-2,2,"")));
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-080.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
Membuat fugsi implisit. Perhatikan perbedaan ekspresi dalam sintaks.
\end{eulercomment}
\begin{eulerprompt}
>writeln(povsurface("pow(x,2)*y-pow(y,3)-pow(z,2)",povlook(green))); ...
>writeAxes(); ...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-081.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Plot3D-082.png}
...
Tentu saja, Anda memerlukan kacamata berwarna red/cyan untuk melihat
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot3D-083.png}
\begin{eulercomment}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{18}{images/EMT4Plot3D-085.png}
\begin{eulercomment}
...
\begin{eulercomment}
Ye, sudah.\\
Selanjutnya kita mendefinisikan dua objek. Yang pertama adalah
pesawat.
