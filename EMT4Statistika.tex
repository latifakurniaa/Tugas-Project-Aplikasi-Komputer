...
\end{euleroutput}
\begin{eulercomment}
Sekarang kita dapat menghitung rata-rata dan simpangan baku sampel
...
\end{euleroutput}
\begin{eulercomment}
Mari kita tambahkan distribusi nilai normal ke plot. Rumus distribusi
normal dengan rata-rata m dan simpangan baku d adalah:
...
String khusus NA = "." diartikan sebagai "Not Available", dan
mendapatkan NAN (not a number) di tabel. Terjemahan ini dapat diubah
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-017.png}
\begin{eulercomment}
...
\eulerheading{Regresi dan Kolerasi}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-038.png}
\begin{eulercomment}
...
koma),  Excel Anda memerlukan nilai dengan koma desimal yang
dipisahkan dengan titik koma dalam file csv (nilai yang dipisahkan
koma). File berikut "test.csv" akan muncul di desktop Anda.
\end{eulercomment}
\begin{eulerprompt}
>filename="test.csv"; ...
...
kami membuat file di direktori home Euler.
\end{eulercomment}
\begin{eulerprompt}
>file="test.csv";  ...
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-049.png}
\begin{eulercomment}
...
\begin{eulercomment}
Tabel juga bisa digunakan untuk membaca atau menulis data numerik.
